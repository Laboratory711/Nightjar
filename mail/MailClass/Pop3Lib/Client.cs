...
namespace Pop3Lib
{
  public class Client
  {
    ...
    public void Connect()
    {
      ...
      _Socket.ReceiveBufferSize = 512; // размер приемного буфера в байтах
    ...
    public void SendMail(string smtpServer, int port, string from, string mailto, string caption, string message)
    {
        try
        {
            ...
            client.Credentials = new NetworkCredential(from.Split('@')[0], _Password);
