...
namespace Pop3Lib
{
  ...
  public class Result
  {
    ...
    {
        string mes = this.Body;
        int i = mes.IndexOf("Content-Type: text/plain;");
        mes = mes.Remove(0, i);
        i = mes.IndexOf("\n");
        mes = mes.Remove(0, i+1);
        i = mes.IndexOf("\n");
        mes = mes.Remove(0, i+1);
        i = mes.IndexOf("Content-Type: text/html;");
        mes = mes.Substring(0, i);
        i = mes.LastIndexOf("\r");
        mes = mes.Remove(i, mes.Length - i);
        i = mes.LastIndexOf("\r");
        mes = mes.Remove(i, mes.Length - i);
        i = mes.LastIndexOf("\r");
        mes = mes.Remove(i, mes.Length - i);
